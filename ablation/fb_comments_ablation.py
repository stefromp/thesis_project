#!/usr/bin/env python3
"""
Ablation study for FB_COMMENTS dataset.
...
Results are saved in:
  {exp_root}/exp/fb-comments/ablation/{exp_name}/results_catboost.json

A consolidated summary across all runs lives in:
  {exp_root}/exp/fb-comments/ablation/ablation_summary.json

Usage — single combination (cluster job):
    python ablation/fb_comments_ablation.py \
...
# ---------------------------------------------------------------------------
# Dataset configuration — derived from exp/fb-comments/ddpm_cb_best/config.toml
# ---------------------------------------------------------------------------
DATASET_NAME = "fb-comments"
