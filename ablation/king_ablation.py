#!/usr/bin/env python3
"""
Ablation study for KING dataset.
...
Results are saved in:
  {exp_root}/exp/king/ablation/{exp_name}/results_catboost.json

A consolidated summary across all runs lives in:
  {exp_root}/exp/king/ablation/ablation_summary.json

Usage — single combination (cluster job):
    python ablation/king_ablation.py \
...
# ---------------------------------------------------------------------------
# Dataset configuration — derived from exp/king/ddpm_cb_best/config.toml
# ---------------------------------------------------------------------------
DATASET_NAME = "king"
