#!/usr/bin/env python3
"""
Ablation study for HIGGS_SMALL dataset.
...
Results are saved in:
  {exp_root}/exp/higgs-small/ablation/{exp_name}/results_catboost.json

A consolidated summary across all runs lives in:
  {exp_root}/exp/higgs-small/ablation/ablation_summary.json

Usage — single combination (cluster job):
    python ablation/higgs_small_ablation.py \
...
# ---------------------------------------------------------------------------
# Dataset configuration — derived from exp/higgs-small/ddpm_cb_best/config.toml
# ---------------------------------------------------------------------------
DATASET_NAME = "higgs-small"
