#!/usr/bin/env python3
"""
Ablation study for INSURANCE dataset.
...
Results are saved in:
  {exp_root}/exp/insurance/ablation/{exp_name}/results_catboost.json

A consolidated summary across all runs lives in:
  {exp_root}/exp/insurance/ablation/ablation_summary.json

Usage — single combination (cluster job):
    python ablation/insurance_ablation.py \
...
# ---------------------------------------------------------------------------
# Dataset configuration — derived from exp/insurance/ddpm_cb_best/config.toml
# ---------------------------------------------------------------------------
