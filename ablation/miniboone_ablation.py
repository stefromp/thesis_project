#!/usr/bin/env python3
"""
Ablation study for MINIBOONE dataset.
...
Results are saved in:
  {exp_root}/exp/miniboone/ablation/{exp_name}/results_catboost.json

A consolidated summary across all runs lives in:
  {exp_root}/exp/miniboone/ablation/ablation_summary.json

Usage — single combination (cluster job):
    python ablation/miniboone_ablation.py \
...
# ---------------------------------------------------------------------------
# Dataset configuration — derived from exp/miniboone/ddpm_cb_best/config.toml
# ---------------------------------------------------------------------------
