#!/usr/bin/env python3
"""
Ablation study for ADULT dataset.
...
Results are saved in:
  {exp_root}/exp/adult/ablation/{exp_name}/results_catboost.json

A consolidated summary across all runs lives in:
  {exp_root}/exp/adult/ablation/ablation_summary.json

Usage — single combination (cluster job):
    python ablation/adult_ablation.py \
...
# ---------------------------------------------------------------------------
# Dataset configuration — derived from exp/adult/ddpm_cb_best/config.toml
# ---------------------------------------------------------------------------
DATASET_NAME = "adult"
